...
\begin{itemize}
  ...
  \item You can also download the \texttt{cslab\_putty\_ssh\_client\_host\_keys\_only} file from \href{https://github.com/benroose/tutorials/tree/master/cslab_tutorials/cslab_ssh_client_config_files}{Ben Roose's GitHub tutorials repository} and re-add the host keys into your Windows registry.
...
%------------------------------------------------
\newpage
\question{How do I copy files from/to the cslab Linux environment via SSH/SFTP on Linux or Mac?}\label{sftp}
...
\begin{itemize}
  ...
  \texttt{sftp cslab-sftp}
  \item To see a list of available \textit{SFTP} interactive commands, at the \texttt{sftp>} command prompt type \texttt{help}
\end{itemize}
...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    %% \item Key file: Type the absolute path to your converted \texttt{cslab.pem} file. Alternatively, click \textbf{Browse}, change the file type from \texttt{PPK file} to \texttt{PEM file}, browse to your \texttt{cslab.pem}, and click \textbf{Open}.
  \end{itemize}
