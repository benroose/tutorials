...
\begin{enumerate}
  ...
  \item Download \texttt{FileZilla} software from the \href{https://filezilla-project.org/download.php?show_all=1}{FileZilla download page} and install the SFTP client on your local Windows computer. Be aware that some \textit{FileZilla} download installers found online come with ``bundled'' adware. Make sure to download the \textit{FileZilla} installer file from the above web-link. Alternatively, you can download a \href{https://ninite.com/filezilla/}{Ninite installer package for FileZilla}.
...
\begin{enumerate}
  \item Ensure you have first followed the directions in the previous section to configure your \textit{OpenSSH} client.
  \item Install the \texttt{filezilla} SFTP client software package using your distribution's package management tools, such as /verb|sudo apt-get install filezilla|, or via the \href{https://filezilla-project.org/download.php?show_all=1}{FileZilla download page}. Mac users can also install \textit{FileZilla} using the \href{http://macappstore.org/filezilla/}{brew package manager}. Be aware that some \textit{FileZilla} download installers found online come with ``bundled'' adware. Make sure to download the \textit{FileZilla} installer file from the above web-link install using a package management tool.
  \item Run the \textit{FileZilla} graphical client program.
