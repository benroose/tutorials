...
\begin{itemize}
\item When connecting to the cslab remote Linux environment using \texttt{ssh cslab}, the ballast load-balancer will redirect you to one of the least used cslab-nodes at time of connection. Since load-balancing is calculated by the ballast system on a one minute cycle, you may not be redirected to the same cslab-node the next time you create an SSH connection into cslab.
